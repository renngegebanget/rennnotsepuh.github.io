  ...
  return (
    <div className='group relative w-full sm:max-w-sm mx-auto overflow-hidden rounded-xl z-10 bg-white shadow-md md:bg-white'>
      <div className='overflow-hidden'>
        <img src={`https://image.thum.io/get/width/1024/${link}`} alt={title} className='w-full md:h-48 h-60 object-cover object-top rounded-xl' />
      </div>
      ...
      <div className='hidden md:block p-4 text-black z-20'>
        ...
        <a href={link} target='_blank' rel='noopener noreferrer' className='bg-teal-600 text-white px-4 py-2 rounded hover:bg-teal-700 transition duration-200'>
          Lihat Proyek
        </a>
      </div>
